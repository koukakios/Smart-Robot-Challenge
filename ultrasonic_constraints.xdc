...
## Header JC UART connections
#set_property PACKAGE_PIN N17 [get_ports tx]
#set_property IOSTANDARD LVCMOS33 [get_ports tx]
#set_property PACKAGE_PIN M18 [get_ports rx]
#set_property IOSTANDARD LVCMOS33 [get_ports rx]

## Header JB Utrasonic connections
set_property PACKAGE_PIN B15 [get_ports echo]
set_property IOSTANDARD LVCMOS33 [get_ports echo]
set_property PACKAGE_PIN B16 [get_ports trigger]
set_property IOSTANDARD LVCMOS33 [get_ports trigger]

## Switches
set_property PACKAGE_PIN V17 [get_ports start_ultrasonic]
set_property IOSTANDARD LVCMOS33 [get_ports start_ultrasonic]
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {obst[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {obst[0]}]
set_property PACKAGE_PIN E19 [get_ports {obst[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {obst[1]}]
set_property PACKAGE_PIN U19 [get_ports {obst[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {obst[2]}]
set_property PACKAGE_PIN V19 [get_ports ultrasonic_valid]
set_property IOSTANDARD LVCMOS33 [get_ports ultrasonic_valid]
