// UART interface wrapper.
// Provides transmit and receive functionality for XBee/serial communication.
// Exposes ready/valid handshake signals for the robot control stack.
module uart (
    input  logic clk,
    input  logic reset,
