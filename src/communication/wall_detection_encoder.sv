// Wall detection encoder.
// Packages ultrasonic obstacle data into an 8-bit encoded response packet.
// Includes parity and duplicate bits for more robust communication.
