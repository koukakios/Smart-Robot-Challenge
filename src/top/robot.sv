// Top-level robot integration module.
// Connects sensor inputs, UART/XBee interface, ultrasonic sensing, and motor control.
// Integrates the main controller, communication controller, and timing resources.
module robot
   (input logic clk,
    input logic reset,
